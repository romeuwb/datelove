            ...
            (function initDatatable() {
                $lwDataTable.each(function (index) {
                    ...
                    if (!_.isUndefined(elementData['order'])) {
                        dtOptions['order'].push([elementData['order'], (!_.isUndefined(elementData['orderType']) ? elementData['orderType'] : 'asc')]);
                    }

                    if (!_.isUndefined(elementData['orderBy'])) {
                        dtOptions['order'].push([
                            elementData['orderBy'],
                    ...
                    $tableHeaders.each(function (index) {
                        ...
                        if (!_.isUndefined(thData['orderBy'])) {
                            // Order type
                            if (thData['orderType']) {
                                dtOptions['order'].push([index,thData['orderType']]);
                            } else {
                                dtOptions['order'].push([index, 'asc']);
                            }
                        }
