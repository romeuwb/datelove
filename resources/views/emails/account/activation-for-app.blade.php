	...
	<tbody>
		...
		<tr style="font-family: Helvetica, Arial, sans-serif;">
			<td class="button" style="border-collapse: collapse; color: #777777; font-family: Helvetica, Arial, sans-serif; font-size: 14px; line-height: 21px; padding: 30px 0; text-align: center;">
				<div style="font-family: Helvetica, Arial, sans-serif;-webkit-text-size-adjust: none; color: #c61d61; border-radius: 5px; display: inline-block; font-family: 'Cabin', Helvetica, Arial, sans-serif; font-size: 25px; font-weight: regular; line-height: 45px; mso-hide: all; text-align: center; text-decoration: none !important;"><?= $otp ?>
				</div>
			</td>
		</tr>
		<tr style="font-family: Helvetica, Arial, sans-serif;">
