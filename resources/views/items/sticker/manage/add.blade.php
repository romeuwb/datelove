 ...
 <div class="d-sm-flex align-items-center justify-content-between mb-4">
 	...
 	<!-- back button -->
 	<a class="btn btn-light btn-sm lw-ajax-link-action lw-action-with-url" data-title="{{ __tr('Manage Stickers') }}" href="<?= route('manage.item.sticker.view') ?>">
 					...
 					<div class="form-group row">
 						...
 						<div class="col-sm-6 mb-3 mb-sm-0">
 							...
 							<div class="input-group">
 								<input type="number" class="form-control d-block" name="normal_price" id="lwNormalPrice" required min="0" digits="true">
 						...
 						<div class="col-sm-6 mb-3 mb-sm-0">
 							...
 							<div class="input-group">
 								<input type="number" class="form-control d-block" name="premium_price" id="lwPremiumPrice" required min="0" digits="true">
 								<div class="input-group-append">
 									<span class="input-group-text"><?= __tr('Credits') ?></span>
 								</div>
 							</div>
