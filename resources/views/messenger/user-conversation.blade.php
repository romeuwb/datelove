<div class="lw-messenger-header row">
    <div class="col-md-11">
        ...
        <div class="float-right pt-3">
            ...
            <a class="btn btn-primary rounded-circle lw-audio-video-btns" style="display: none;" id="lwAudioCallDisableBtn"><i class="fas fa-phone-alt" title="<?= __tr('Audio Call') ?>"></i></a>
            <!-- audio call button -->
            <a class="btn btn-primary rounded-circle lw-audio-video-btns" style="display: none;" href type="button" id="lwAudioCallBtn" data-user-uid="<?= $userData['user_uid'] ?>" data-call-type="audio" data-confirm="#lwCallErrorContainer" title="<?= __tr('Audio Call') ?>"><i class="fas fa-phone-alt"></i></a>
            <!-- /audio call button -->
            @endif

            @if(getFeatureSettings('video_call_via_messenger'))
            <a class="btn btn-primary rounded-circle lw-audio-video-btns" style="display: none;" id="lwVideoCallDisableBtn" readonly><i class="fas fa-video" title="<?= __tr('Video Call') ?>"></i> </a>
            <!-- video call button -->
            <a class="btn btn-primary rounded-circle lw-audio-video-btns" style="display: none;" href type="button" id="lwVideoCallBtn" data-user-uid="<?= $userData['user_uid'] ?>" data-call-type="video" data-confirm="#lwCallErrorContainer" title="<?= __tr('Video Call') ?>"><i class="fas fa-video"></i> </a>
            <!-- /video call button -->
            @endif
            @endif
            <div class=" lw-messenger-user-menu">
                <div class="dropdown">
                    <button class="btn btn-primary rounded-circle dropdown-toggle lw-datatable-action-dropdown-toggle" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
