<div class="lw-messenger-header row">
    <div class="col-md-11">
        ...
        <div class="float-right pt-3">
            @if(isAdmin())
                <!-- like button -->
                <a href data-action="<?= route('fake_user.write.like_dislike', ['fromUserId' => $userData['optionalLoggedInUserId'], 'toUserUid' => $userData['user_uid'], 'like' => 1]) ?>" data-method="post" data-callback="onLikeCallback" title="{{ __tr('Like') }}" class="lw-ajax-link-action lw-like-action-btn btn rounded-circle btn-secondary" id="lwLikeBtn">
                ...
                <!-- /like button -->
                <!-- dislike button -->
                <a href data-action="<?= route('fake_user.write.like_dislike', ['fromUserId' => $userData['optionalLoggedInUserId'],'toUserUid' => $userData['user_uid'], 'like' => 0]) ?>" data-method="post" data-callback="onLikeCallback" title="{{ __tr('Dislike') }}" class="lw-ajax-link-action lw-dislike-action-btn btn rounded-circle btn-secondary" id="lwDislikeBtn">
            ...
            <div class="lw-messenger-user-menu">
                <div class="dropdown">
                    <button class="btn btn-secondary rounded-circle dropdown-toggle lw-datatable-action-dropdown-toggle" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
